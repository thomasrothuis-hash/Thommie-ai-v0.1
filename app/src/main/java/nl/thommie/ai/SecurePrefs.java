...
final class SecurePrefs {
    private static final String PREFS = "thommie_ai_secure";
    private static final String ALIAS = "thommie_ai_v01_key";
    ...
    static void saveApiKey(Context context, String value) throws Exception {
        ...
        prefs(context).edit().putString(API_KEY, blob).apply();
    }

    static String loadApiKey(Context context) {
        try {
            String blob = prefs(context).getString(API_KEY, null);
            if (blob == null) return "";
